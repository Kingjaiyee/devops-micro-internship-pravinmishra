...
![GitHub dashboard showing signed-in account](screenshots/task1-dashboard.png)
...
![GitHub profile with the profile URL visible in the address bar](screenshots/task1-profile-url.png)
...
![GitHub Trending page](screenshots/task2-trending.png)

---

#### Screenshot 4 — A repository page showing the Star button in the Starred state

![Repository page showing the Star button in the Starred state](screenshots/task2-starred.png)

---

#### Screenshot 5 — Your forked repository page with your username and repository name visible in the URL

![Forked repository page with username and repository name in the URL](screenshots/task2-fork.png)
...
![Public GitHub profile showing username and professional bio](screenshots/task3-profile-bio.png)
