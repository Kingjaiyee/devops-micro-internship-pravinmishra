...
![Fork page showing Kingjaiyee/devops-micro-internship-interviews](screenshots/a5-task0-fork-page.png)
...
![Credential helper output showing manager](screenshots/a5-task1-credential-helper.png)
...
![git remote -v showing origin and upstream](screenshots/a5-task2-remotes.png)
...
![git status showing pull_request.md modified](screenshots/a5-task3-status.png)

---

#### Screenshot 5 — Output of `git commit`

![git commit output for docs: add my name to student list](screenshots/a5-task3-commit.png)
...
![Successful push of feature-readme-update to origin](screenshots/a5-task4-push.png)

---

#### Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner

![Fork showing feature-readme-update branch one commit ahead](screenshots/a5-task4-fork-branch.png)
...
![Pull request comparison page with correct base and head branches](screenshots/a5-task5-compare.png)

---

#### Screenshot 9 — Successfully created Pull Request page with the PR number visible

![Created pull request #407 with Open status](screenshots/a5-task5-pr-created.png)
...
`https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/407`
...
`https://www.linkedin.com/posts/victor-jaiye_dmibypravinmishra-devops-git-share-7486527882203312129-Wc8r/`

---

#### Screenshot — LinkedIn post showing your successfully created Pull Request

![LinkedIn post covering the Week 4 Assignment 5 pull request](screenshots/a5-linkedin-post.png)
...
`https://github.com/Kingjaiyee/devops-micro-internship-interviews`
