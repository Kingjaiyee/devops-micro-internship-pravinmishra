...
![Space created](screenshots/a2-task1-space-created.png)
...
![Epic created](screenshots/a2-task2-epic-created.png)
...
![Backlog with six Stories](screenshots/a2-task3-backlog-six-stories.png)

---

#### Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label

![Story detail](screenshots/a2-task3-story-detail.png)
...
![S2 sub-tasks](screenshots/a2-task4-s2-subtasks.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![S4 sub-tasks](screenshots/a2-task4-s4-subtasks.png)
...
![Labels applied](screenshots/a2-task5-labels.png)
...
![Sprint before start](screenshots/a2-task6-sprint-before-start.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Active sprint board](screenshots/a2-task6-sprint-active.png)
...
![Frontend filter](screenshots/a2-task7-filter-frontend.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![Devops filter](screenshots/a2-task7-filter-devops.png)
...
![Burndown chart](screenshots/a2-task8-burndown.png)
