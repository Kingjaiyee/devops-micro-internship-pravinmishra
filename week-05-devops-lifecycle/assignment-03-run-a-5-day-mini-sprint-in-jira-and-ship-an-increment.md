...
![Sprint 1 created with the Story inside it](screenshots/a3-task1-sprint-created.png)

---

#### Screenshot 2 — Active Sprint board showing the Sprint Goal

![Active Sprint board showing the Sprint Goal](screenshots/a3-task1-active-sprint-goal.png)
...
![Jira board showing the Day 1 Sub-task in Done](screenshots/a3-task2-jira-day1-done.png)

---

#### Screenshot 4 — Successful Git commit output

![Successful Git commit output](screenshots/a3-task2-commit.png)

---

#### Screenshot 5 — EC2 browser view showing the complete footer text, with the URL visible

![EC2 browser view showing the complete footer text, with the URL visible](screenshots/a3-task2-ec2-footer.png)

---

#### Screenshot 6 — Jira Story comment showing the Day 1 Daily Scrum update

![Jira Story comment showing the Day 1 Daily Scrum update](screenshots/a3-task2-jira-day1-scrum.png)
...
![Code editor showing the footer and date logic](screenshots/a3-task3-code-datelogic.png)

---

#### Screenshot 8 — EC2 browser view showing the updated footer with the current date

![EC2 browser view showing the updated footer with the current date](screenshots/a3-task3-ec2-footer-date.png)

---

#### Screenshot 9 — README snippet documenting the footer and date behavior

![README snippet documenting the footer and date behavior](screenshots/a3-task3-readme.png)

---

#### Screenshot 10 — Jira Story comment showing the Day 2 Daily Scrum update

![Jira Story comment showing the Day 2 Daily Scrum update](screenshots/a3-task3-jira-day2-scrum.png)
...
![Desktop EC2 view showing the polished footer](screenshots/a3-task4-desktop-footer.png)

---

#### Screenshot 12 — Mobile responsive view showing the footer remains readable

![Mobile responsive view showing the footer remains readable](screenshots/a3-task4-mobile-footer.png)

---

#### Screenshot 13 — Jira Story comment showing the Day 3 Daily Scrum update

![Jira Story comment showing the Day 3 Daily Scrum update](screenshots/a3-task4-jira-day3-scrum.png)
...
![EC2 browser view showing Start your DevOps Journey here and the clickable Visit the DMI Website link](screenshots/a3-task5-homepage-cta.png)
...
![Burndown Chart for Sprint 1](screenshots/a3-task6-burndown.png)

---

#### Screenshot 16 — Jira retrospective comment

![Jira retrospective comment](screenshots/a3-task6-retro.png)

---

#### Screenshot 17 — Final EC2 browser view showing the complete footer requirement

![Final EC2 browser view showing the complete footer requirement](screenshots/a3-task6-final-footer.png)
...
`https://www.loom.com/share/d9abd2aafd6149549fa17b05034c9e41`
...
`https://www.linkedin.com/posts/victor-jaiye_dmi-devops-micro-internship-with-agentic-share-7491495773227016194-scBe/`

---

#### LinkedIn Screenshot 1 — Published LinkedIn post showing the post content and at least one required link or proof image

![Published LinkedIn post showing the post content and proof image](screenshots/a3-linkedin-post.png)
