...
![Generic Claude response before CLAUDE.md](screenshots/a2ss1.png)
...
![Auto-generated CLAUDE.md](screenshots/a2ss2.png)
...
![Customized CLAUDE.md with all 5 sections](screenshots/a2ss3.png)
...
![Claude detailed answer mentioning S3, CloudFront, Terraform](screenshots/a2ss4.png)

---

#### Screenshot 5 — Claude refusing or warning against adding React because of the "No JavaScript" convention defined in CLAUDE.md

![Claude refusing React due to No JavaScript convention](screenshots/a2ss5.png)
...
![CLAUDE.md visible in GitHub repository](screenshots/a2ss6.png)
