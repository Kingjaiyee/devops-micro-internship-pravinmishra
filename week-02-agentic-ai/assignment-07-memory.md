...
![Memory file path shown by Claude](screenshots/a7ss1.png)
...
![Claude confirming memory was saved](screenshots/a7ss2.png)

---

#### Screenshot 3 — The `MEMORY.md` file open in VS Code showing the saved content

![MEMORY.md saved content](screenshots/a7ss3a.png)

![MEMORY.md saved content continued](screenshots/a7ss3b.png)
...
![Fresh Claude Code session after restart](screenshots/a7ss4.png)
...
![Claude recalling hero section colors](screenshots/a7ss5.png)

---

#### Screenshot 6 — Claude refusing JavaScript request based on memory rule

![Claude refusing JavaScript based on memory rule](screenshots/a7ss6.png)
