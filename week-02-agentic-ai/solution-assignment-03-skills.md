...
![.claude/skills folder with 4 subfolders](screenshots/a3ss1.png)
...
![scaffold-terraform folder with SKILL.md and template-spec.md](screenshots/a3ss2.png)
...
![tf-plan SKILL.md frontmatter with tool restrictions](screenshots/a3ss3.png)
...
![scaffold-terraform complete with file list](screenshots/a3ss4.png)

---

#### Screenshot 5 — VS Code sidebar showing the `terraform/` folder with all generated files inside

![terraform folder with generated files](screenshots/a3ss5.png)
...
![tf-plan response with command output analyzed](screenshots/a3ss6.png)
