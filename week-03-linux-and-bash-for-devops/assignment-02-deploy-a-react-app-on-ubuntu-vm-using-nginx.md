...
![node and npm versions](screenshots/a2ss1.png)
...
![nginx active and running](screenshots/a2ss2.png)
...
![my-react-app project files](screenshots/a2ss3.png)
...
![App.js with full name and date](screenshots/a2ss4.png)
...
![build folder generated](screenshots/a2ss5.png)
...
![deployed build contents in web root](screenshots/a2ss6.png)
...
![nginx is-active output](screenshots/a2ss7.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![nginx default site config](screenshots/a2ss8.png)
...
![curl ifconfig.me public IP](screenshots/a2ss9.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![React app in browser with name and date](screenshots/a2ss10.png)
...
`https://www.linkedin.com/posts/victor-jaiye_dmibypravinmishra-devops-linux-share-7484026830853795840-DkHR/`

---

#### Screenshot — LinkedIn post showing the deployed application

![LinkedIn post showing the deployed application](screenshots/a2ss11.png)
