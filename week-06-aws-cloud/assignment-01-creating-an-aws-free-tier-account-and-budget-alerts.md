...
![Screenshot 1](screenshots/a1-task2-budget.png)
...
AWS bills by usage, and costs can climb quietly in the background without any obvious signal, so by the time a bill arrives the money is already spent. Budget alerts turn that silence into early warning. I set a $10 monthly budget with three thresholds at 50%, 80%, and 100% of actual spend, each emailing me, so I get told when spend crosses each level rather than finding out at the end of the month. That staged warning gives me time to react: check what is running, shut down anything I left on, or fix a misconfiguration before it does real damage. On a Free Tier learning account this matters even more, because it is easy to spin up a resource for practice and forget it, and a single forgotten instance can quietly run up charges. The alerts do not stop spending on their own, but they make sure I always know where I stand and can act before a small mistake becomes an expensive one.
